    ...
    <>
      ...
      <Box as="section" bg={mode("gray.50", "gray.800")} py="20">
        ...
        >
          ...
          <p>Welcome to lettersender.app!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of Letter Sender's Website, located at https://lettersender.app.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use lettersender.app if you do not
          ...
          <p>
            We employ the use of cookies. By accessing lettersender.app, you
            agreed to use cookies in agreement with the Letter Sender's Privacy
            Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, Letter Sender and/or its licensors own the
            intellectual property rights for all material on lettersender.app.
            All intellectual property rights are reserved. You may access this
            from lettersender.app for your own personal use subjected to
            restrictions set in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from lettersender.app</li>
            <li>Sell, rent or sub-license material from lettersender.app</li>
            <li>Reproduce, duplicate or copy material from lettersender.app</li>
            <li>Redistribute content from lettersender.app</li>
          </ul>
          ...
          <p>
            ...
            Letter Sender does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of Letter Sender,its agents and/or affiliates.
            ...
            Letter Sender shall not be liable for the Comments or for any
          ...
          <p>
            Letter Sender reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant Letter Sender a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Letter
            Sender; and (d) the link is in the context of general resource
            information.
          </p>
          ...
          <p>
            ...
            sending an e-mail to Letter Sender. Please include your name, your
          ...
          <p>
            No use of Letter Sender's logo or other artwork will be allowed for
